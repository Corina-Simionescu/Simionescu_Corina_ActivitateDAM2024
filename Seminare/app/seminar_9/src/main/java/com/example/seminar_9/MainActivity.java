...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonListaImagini = findViewById(R.id.buttonListaImagini);
        buttonListaImagini.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        Button buttonDateJsonASE = findViewById(R.id.buttonDateJsonASE);
        buttonDateJsonASE.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, DateJsonActivity.class);
                startActivity(intent);
            }
        });

        Button buttonVreme = findViewById(R.id.buttonVreme);
        buttonVreme.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, VremeActivity.class);
                startActivity(intent);
            }
        });
    }
