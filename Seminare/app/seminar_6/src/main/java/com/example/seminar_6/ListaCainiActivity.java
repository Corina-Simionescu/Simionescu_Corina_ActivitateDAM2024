...
//        ArrayAdapter<Caine> adapter = new ArrayAdapter<>(getApplicationContext(), android.R.layout.simple_list_item_1, caini);
//        listViewCaini.setAdapter(adapter);
//        seminar 6:
