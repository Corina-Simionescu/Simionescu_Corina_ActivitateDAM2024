...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonListaFavorite = findViewById(R.id.buttonListaFavorite);
        buttonListaFavorite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, ListaCainiFavoritiActivity.class);
                startActivity(intent);
            }
        });
    }
